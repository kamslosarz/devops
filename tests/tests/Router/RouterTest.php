...
class RouterTest extends \PHPUnit\Framework\TestCase
{
    public function testShouldMatchRoute()
    {
        ...
        $this->assertEquals('Test\Decorator\ControllerDecorator', $route->getController());
    ...
    {
        $relativeUrl = \Application\Router\Router::getRouteUrlByParameters(\Test\Decorator\ControllerDecorator::class, 'projectAction', ['id' => 9999]);
